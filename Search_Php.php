...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$sample[0]'>$sample[0]</a></li>";
    echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$sample[1]'>$sample[1]</a></li>";
    echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$sample[2]'>$sample[2]</a></li>";
    echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$sample[3]'>$sample[3]</a></li>";
    echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$sample[4]'>$sample[4]</a></li>";
    echo "</ul>";
...
function display_search($raw_text){
  echo "<div id='tfheader'>
    <form  method='GET' action='http://localhost/IRProjectV2/Search_Php.php?querybox='$raw_text'>
			...
			<input type='button' id='myBtn' value='View Analytics'>
    </form>
...
function display_search_empty(){
  ...
  echo "<div id='tfheader'>
    ...
    <form action='http://localhost/IRProjectV2/Search_Php.php?querybox=$search_empty'>
    </form>
   <div class='tfclear'>
   </div>
   </div>";
  ...
  foreach($xml_data->result->children() as $doc){
       foreach($doc->arr as $entity){
        ...
        if($entity_name == "hashtags"){
          ...
          echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$custom_search_tag'>$myArray[0]</a></li>";
            $counter = $counter + 1;
        }
       }
       if($counter == 5){
       ...
       foreach($doc->arr as $entity){
        ...
        if($entity_name == "cluster_name"){
              ...
              if (!in_array($cluster_name, $Topics_Array)){
                 ...
                 echo "<li><a href='http://localhost/IRProjectV2/Search_Php.php?querybox=$cluster_name'>$cluster_name</a></li>";
              }
             if($counter == 5){
              break 2;
             }    
